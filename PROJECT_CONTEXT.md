...
ZIP release filename is versioned, for example `automated-features-helper-v0.2.0.zip`. The folder inside the archive must be exactly `automated-features-helper`.
